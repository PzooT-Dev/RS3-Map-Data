...
export const MAP_HEIGHT_PX = 370400; // Total height of the map in px at max zoom level
export const RS_TILE_WIDTH_PX = 32, RS_TILE_HEIGHT_PX = 32; // Width and height in px of an rs tile at max zoom level
export const RS_OFFSET_X = 64; // Amount to offset x coordinate to get correct value
export const RS_OFFSET_Y = 4873; // Amount to offset y coordinate to get correct value
